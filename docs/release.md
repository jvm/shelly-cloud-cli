...
```bash
node scripts/homebrew-formula.mjs 0.1.7 \
  https://github.com/jvm/shelly-cloud-cli/releases/download/v0.1.7/shelly-cloud-cli-0.1.7.tgz \
  <sha256>
```
...
```bash
bunx --package shelly-cloud-cli@0.1.7 shelly-cloud --version
```
